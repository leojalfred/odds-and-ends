...
5. Pick a graduated level you cannot pay for and confirm it is grayed and unclickable. Drop to one you can and confirm the count matches the governors on the map. Every Eligible Governor must never be grayed, since it only ever commits what you can cover.
